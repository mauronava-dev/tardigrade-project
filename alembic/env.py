...
It supports both online (connected to database) and offline (SQL script generation) modes.
"""
...
from src.infrastructure.database.sql.models.user import UserModel  # noqa: F401
...
def get_url() -> str:
    ...
    return os.getenv(
        "DATABASE_URL",
        config.get_main_option("sqlalchemy.url", "postgresql+asyncpg://postgres:postgres@localhost:5432/tardigrade"),
    )
